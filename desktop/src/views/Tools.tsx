...
const TOOL_DEFINITIONS: ToolInfo[] = [
  ...
  { name: 'Agent', category: 'built-in', description: 'Launch specialized subagent', parameters: { subagent_type: { type: 'string', description: 'Agent type', required: true }, prompt: { type: 'string', description: 'Task description', required: true } } },
